  ...
  return (
    <div className="grid justify-center items-center bg-base-300 relative pb-10">
       <h1 className="text-center mb-8">
            ...
            MHGD can only be minted using USDC & DAI StableCoins.
          </h1>
        ...
        <div className={`mt-10 flex gap-2 ${visible ? "" : "invisible"} max-w-2xl`}>
          <div className="flex gap-5 bg-base-200 bg-opacity-80 z-0 p-7 rounded-2xl shadow-lg">
            ...
            <div>
              ...
              <div className="mt-2">
                Set a spending cap for your USDC or MHGD above{" "}
                <div> <code className="italic bg-base-300 text-base font-bold [word-spacing:-0.5rem]">
                  We -recommend -setting -a -cap- below- your -total -balance, but above what you plan to use!
                </code>{" "}</div>
               
                then use your USDC to mint MHGD or swap between the assets.
              </div>
            </div>
          </div>
          <button
